...
void onMqttMessage(char* topic, char* payload, AsyncMqttClientMessageProperties properties, size_t len, size_t index, size_t total) {
  ...
  // if (payload==nullptr) {
  //   Serial.println(F("no payload -> leave"));
  //   return;
  // }
...
bool initMqtt()
{
  // if (!Config.mqttEnabled || mqttServer[0] == 0) return false;
  ...
  // }
  // mqtt->setClientId(Config.mqttClientId.c_str());
  // if (Config.mqttUsername != "" && Config.mqttPassword != "")
  //   mqtt->setCredentials(Config.mqttUsername.c_str(), Config.mqttPassword.c_str());
